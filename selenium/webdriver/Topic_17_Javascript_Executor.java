...
public class Topic_17_Javascript_Executor {
    ...
    public void beforeClass(){
        ...
        email = "David" + new Random().nextInt(999) + "@gmail.com";
        password = "123456a@";
    ...
    public void TC01_TechPanda(){
        ...
        String SonyMessage =getInnerText();
        Assert.assertTrue(SonyMessage.contains("Sony Xperia was added to your shopping cart."));
        Assert.assertTrue(isExpectedTextInInnerText("Sony Xperia was added to your shopping cart."));
        ...
        sendkeyToElementByJS("//input[@id='newsletter']","David" + new Random().nextInt(9999)+ "@gmail.com");
        sleepInSecond(2);
    ...
    public void TC_02_Validation_Message() {
        ...
        driver.findElement(By.cssSelector("form#login-form input#id_email")).sendKeys("123@123@");
        driver.findElement(By.cssSelector("form#login-form button[name='continue']")).click();
        sleepInSecond(2);
